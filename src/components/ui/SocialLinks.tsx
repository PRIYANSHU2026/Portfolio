...
const defaultLinks: SocialLink[] = [
  {
    icon: Github,
    link: "https://github.com/PRIYANSHU2026",
    label: "GitHub",
    delay: 0
  },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/priyanshu-tiwari-ml/",
    label: "LinkedIn",
    delay: 0.1
  },
  {
    icon: Mail,
    link: "mailto:priyanshutiwari112@gmail.com",
    label: "Email",
    delay: 0.2
  },
  {
    icon: Twitter,
    link: "https://twitter.com/Priyans46814724",
    label: "Twitter",
    delay: 0.3
  }
];
