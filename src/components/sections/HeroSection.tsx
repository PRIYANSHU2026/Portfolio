      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <p className="text-xl mb-8 text-slate-300 leading-relaxed">
            A multifaceted AI/ML enthusiast and researcher with a deep passion for developing cutting-edge
            AI solutions across diverse domains, including Medical Imaging, Electrical Systems, Biotechnology,
            Financial Analytics, and Mechanical Engineering. Dedicated to driving impactful innovations through
            interdisciplinary research and real-world applications of Artificial Intelligence and Machine Learning.
          </p>
        ...
        >
          <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-blue-500/30 shadow-xl bg-slate-800 flex items-center justify-center relative">
            <Image
            ...
            />
            <div className="absolute inset-0 rounded-full shadow-inner border border-blue-400/20"></div>
          </div>
        </motion.div>
      </div>
